  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-gray-50">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-xs text-gray-400 font-medium mb-1">성균관대학교 퀀트응용경제학과</p>
        <h1 className="text-xl font-bold text-gray-900">총무부 장부</h1>
      </div>
      ...
      <p className="mt-6 text-xs text-gray-300">퀀트응용경제학과 구성원만 이용할 수 있습니다</p>
    </div>
  );
}
